...
function addMention(editorState, mention, mentionTrigger, entityMutability) {
  var _mention$replaceText;
  ...
  var mentionReplacedContent = draftJs.Modifier.replaceText(editorState.getCurrentContent(), mentionTextSelection, (_mention$replaceText = mention.replaceText) != null ? _mention$replaceText : mention.title, undefined, // no inline style needed
  ...
  var triggerForSelectionInsideWord = leaves.filter(filterUndefineds).map(function (_ref) {
    ...
    return mentionTriggers.map(function (trigger) {
      return (// @ is the first character
        ...
        blockText.substr(0, trigger.length) === trigger && anchorOffset <= end || mentionTriggers.length > 1 && anchorOffset >= start + trigger.length && (blockText.substr(start + 1, trigger.length) === trigger || blockText.substr(start, trigger.length) === trigger) && anchorOffset <= end || mentionTriggers.length === 1 && anchorOffset >= start + trigger.length && anchorOffset <= end ? trigger : undefined
      );
...
var MentionSuggestions = /*#__PURE__*/function (_Component) {
  ...
  function MentionSuggestions(props) {
    ...
    _this.onMentionSelect = function (mention) {
      ...
      var newEditorState = addMention(_this.props.store.getEditorState(), mention, _this.lastActiveTrigger || "", _this.props.entityMutability);
...
var defaultTheme = {
  mention: linaria.css(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n    &,\n    &:visited {\n      color: #575f67;\n      cursor: pointer;\n      display: inline-block;\n      background: #e6f3ff;\n      padding-left: 2px;\n      padding-right: 2px;\n      border-radius: 2px;\n      text-decoration: none;\n    }\n    &:hover,\n    &:focus {\n      color: #677584;\n      background: #edf5fd;\n      outline: 0; /* reset for :focus */\n    }\n    &:active {\n      color: #222;\n      background: #455261;\n    }\n  "]))),
  // CSS class for suggestions component
  mentionSuggestions: linaria.css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(["\n    border: 1px solid #eee;\n    position: absolute;\n    min-width: 220px;\n    max-width: 440px;\n    background: #fff;\n    border-radius: 2px;\n    box-shadow: 0px 4px 30px 0px rgba(220, 220, 220, 1);\n    cursor: pointer;\n    padding-top: 8px;\n    padding-bottom: 8px;\n    z-index: 2;\n    display: flex;\n    flex-direction: column;\n    box-sizing: border-box;\n    transform: scale(0);\n  "]))),
  // CSS classes for an entry in the suggestions component
  mentionSuggestionsEntry: linaria.css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteralLoose(["\n    ", "\n  "])), entryShared),
  mentionSuggestionsEntryFocused: linaria.css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteralLoose(["\n    ", "\n    background-color: #e6f3ff;\n  "])), entryShared),
  mentionSuggestionsEntryText: linaria.css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteralLoose(["\n    display: inline-block;\n    margin-left: 8px;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    max-width: 368px;\n    font-size: 0.9em;\n    margin-bottom: 0.2em;\n  "]))),
  mentionSuggestionsEntryAvatar: linaria.css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteralLoose(["\n    display: inline-block;\n    width: 24px;\n    height: 24px;\n    border-radius: 12px;\n  "])))
};
...
var defaultSuggestionsFilter$1 = function defaultSuggestionsFilter(searchValue, suggestions, trigger) {
  ...
  var filteredSuggestions = triggerSuggestions.filter(function (suggestion) {
    return !value || suggestion.title.toLowerCase().indexOf(value) > -1;
  });
