...
function getTriggerForMention(editorState, searches, mentionTriggers) {
  console.log(searches); // get the current selection
...
var defaultTheme = {
  ...
  mentionSuggestions: "m1ujdjs9",
  // CSS classes for an entry in the suggestions component
  mentionSuggestionsEntry: "m1pa8sjt",
  mentionSuggestionsEntryFocused: "m1rhk4y7",
  mentionSuggestionsEntryText: "msvy2u2",
  mentionSuggestionsEntryAvatar: "m8ya0g9"
};
